...
% countability.tex v3.0 (c) | Copyright 2023 Daniel E. Janusch
...
\begin{section}{Introduction and Countability Theorems}\label{sec:background}
	...
	\begin{align}
		...
		\aleph_0 & := |\mathbb N|~~~(3\text a)\hspace{12em}\aleph_1 := |\mathbb R|~~~(3\text b)\\
		C(S) & :=\begin{cases}
	...
	\end{thm}\begin{proof}% TODO: Continue here
		...
		numbering than that of Theorem~\ref{thm:multiplications}.\vspace{0.5em}
