...
namespace Max7219::SevenSegment {
	...
	static u8 decode_states[MAX7219_MAXDEVICES];
	...
	[[maybe_unused]]
	static FORCE_INLINE void intensity(u8 device, u8 value) {
		if (device >= ndevices)
			return;
	...
	[[maybe_unused]]
	static FORCE_INLINE void decode(u8 device, u8 value) {
		if (device >= ndevices)
			return;
	...
	[[maybe_unused]]
	static FORCE_INLINE void update(u8 device, u8 d0, u8 d1, u8 d2, u8 d3, u8 d4, u8 d5, u8 d6, u8 d7) {
	...
	[[maybe_unused]]
	static FORCE_INLINE void update(u8 device, u8 s[8]) {
	...
	[[maybe_unused]]
	static FORCE_INLINE void setDigit(u8 device, u8 digit, u8 x) {
	...
	[[maybe_unused]]
	static FORCE_INLINE void setDigit(u8 digit, u8 *xs) {
	...
	[[maybe_unused]]
	static FORCE_INLINE void setSegment(u8 device, u8 digit, u8 segment, u8 b) {
	...
	[[maybe_unused]]
	static FORCE_INLINE void toggleDigit(u8 device, u8 digit, u8 mask = 0xFF) {
		if (device >= ndevices || digit > 7)
			return;
	...
	[[maybe_unused]]
	static FORCE_INLINE void toggleDigit(u8 digit, u8 *masks) {
	...
	[[maybe_unused]]
	static FORCE_INLINE void toggleSegment(u8 device, u8 digit, u8 segment) {
		if (device >= ndevices || digit > 7 || segment > 7)
			return;
	...
	[[maybe_unused]]
	static FORCE_INLINE void init(u8 num_devices = MAX7219_MAXDEVICES, bool decodeMode = false) {
	...
	[[maybe_unused]]
	static FORCE_INLINE void init(bool decodeMode) {
		init(MAX7219_MAXDEVICES, decodeMode);
	}
}
