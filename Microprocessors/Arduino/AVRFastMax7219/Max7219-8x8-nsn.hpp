...
namespace Max7219::Matrix {
	...
	[[maybe_unused]]
	static FORCE_INLINE void setRow(u8 device, u8 row, u8 x) {
	...
	[[maybe_unused]]
	static FORCE_INLINE void setRow(u8 row, u8 *xs) {
	...
	[[maybe_unused]]
	static void setCol(u8 col, u8 x) {
	...
	[[maybe_unused]]
	static FORCE_INLINE void setCell(u8 device, u8 row, u8 col, u8 b) {
	...
	[[maybe_unused]]
	static FORCE_INLINE void toggleCell(u8 device, u8 row, u8 col) {
		if (device >= ndevices || row > 7 || col > 7)
			return;
