def rock_paper_scissors() -> None:
    ...
    while 1: player = ""
        ...
        computer, player, winner = randint(1, 3), int(player in {"1", "rock"}) or 3 - (player in {"2", "paper"}), player == computer and "tie" or player in {computer - 2, computer + 1} and "player" or "computer"
        scores[winner] += 1
