...
var Intrinsics = (() => {
	class Intrinsics {
		// this class is only used for assertions
		constructor()   {
			this["("]  = 1;
			this[")"]  = 2;
			this.elif  = 3;
			// TODO: Add 'ret' instead of return because it's too many letters.
			this.lbl   = 4;
			this.goto  = 5;
			this.push  = 6;
			this.print = 7;
			...
			this.skip  = 10;
			this.pop   = 11;
			this.shift = 12; /* I know that shift is not for stacks. I don't care */
		}
	}
	var intrinsics = new Intrinsics();
	Intrinsics.prototype.length = len(Object.keys(intrinsics));
	return intrinsics;
=======
// This file reqiures ./lib.js
