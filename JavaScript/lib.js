		...
		**/
		...
		, "instance Logic"    : class Logic {
			...
			constructor(
				...
				this.sqrt5 = 2.23606797749979; this.π_2 = π_2; // Math.π_2 == Math.π/2 but faster
				this.Math = Math;
				/*
					G = 6.67m³/(10¹¹ kg s²)
					∑∏Δ×∙÷±∓∀∃∄∤⌈⌉⌊⌋⋯〈〉√∛∜≤≥≠≈≋≍≔≟≡≢≶≷⋚⋛⁽°⁰¹²³⁴⁵⁶⁷⁸⁹⁺⁻⁼⁾∞
				...
				*/// TODO: Update rMath.help
				...
				return this.isNaN( x = Number(x) ) ? x :
					`${zeroX ? "0x" : sixteenColon ? "16:" : ""}${this.base10Conv(x, 16).slc(3)}`;
